...
class KernelTest(unittest.TestCase):
    ...
    def test_kernel_make_new_pcb_and_run_that(self):
        ...
        self.kernel.run('C:/Program Files(x86)/pyCharm/pyCharm.exe')
        self.kernel.run('C:/Users/ATRR/Download/vlc-setup.msi')
    ...
    def test_kernel_run_pcb_who_enter_in_io_device(self):
        ...
        self.assertEqual(self.kernel.pcb_table.table[0], self.kernel.ioDeviceController.currentPCB)
